...
function restructureToFolderDiv(node){
    ...
    let title = node.children[0]; // don't use childNodes[], because it contains only meaningless newline-only text nodes (all texts are wrapped in <p>, no bare text node is generated by markdown-it)
