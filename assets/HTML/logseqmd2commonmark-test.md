...
- 2. Inline ID: This is a block discussing the new `id:: 00000000-0002-0001-0000-000000000000` inline syntax to verify it does not parse as a block ID property.
...
- 5. logseq-meta Anchor Protection:
	- 5.1 Code Block:
	  ...
	  ```
	- 5.2 Math Block:
	  id:: 00000000-0005-0002-0000-000000000000
	  $$
	  x^2 + y^2 = z^2
	  $$
...
- 7. Hashed UUID Titles:
	...
	- 7.2 Reference block referencing the local target: ((00000000-0007-0001-0000-000000000000))
