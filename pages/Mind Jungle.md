				...
				- About the term “vacantism”
				  collapsed:: true
					...
					- Chinese terms from abstract to concrete: 元 (first, prime) → 原 (root, origin) → 源 (source)
						- The original meaning of “no first” (無元) simply because in ((66537a44-f579-4fcc-a02b-2f32d0d409fc)), every concrete thing is circular, thus the whole Universe is circular
