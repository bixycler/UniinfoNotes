					  ...
					  id:: 6a54c798-becc-4879-80f9-bb35731f4e44
						...
						- Setup
							...
							- [Service Account](https://console.cloud.google.com/iam-admin/serviceaccounts?project=vertex-ai-agent-499213) for the project
								...
								- [JSON Keys](https://console.cloud.google.com/iam-admin/serviceaccounts/details/110834434229891063644/keys?project=vertex-ai-agent-499213): `3aeeae4b313feba30791be7aa6dd5096b9911ffa` downloaded as `vertex-ai-agent-499213-3aeeae4b313f.json` (if lost, it won't be retrieved, must re)
						- Check available models: https://generativelanguage.googleapis.com/v1beta/models?key=${GeminiAPIKey}
