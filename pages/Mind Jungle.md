		  ...
		  collapsed:: true
			...
			- Example: effect flow of a mission via a field agent in the field
			  collapsed:: true
				...
				- Relativity of the self: There are many different offices in the field. A field agent can chose one office to work for, whose it/they considers as “my office”, giving “my cause” (called “the cause”) for me to produce “my effect” (called “the effect”). Actually, the effect of “the cause” is not only “the effect” but also included in the outcomes of all other missions which have interaction with this field agent. That means the linear relation from “the cause” to “the effect” is just relative to the choice of office, i.e. of the self.
