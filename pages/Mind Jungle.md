			...
			- ((665359ff-79f1-4669-b10b-f2b0e633a7c1))
				- About the term “vacantism”
				  collapsed:: true
					...
					- Note that vacantism does not deny the presence of a supreme being, esp. an [immanent](https://en.wikipedia.org/wiki/Immanence) one. The “throne of the supreme being” is said to be **vacant** not because there can be no such being, but because no being is **entitled** to that throne by default.
