				...
				- About the term “vacantism”
				  collapsed:: true
					...
					- Chinese terms from abstract to concrete: 元 (first, prime) → 原 (root, origin) → 源 (source)
						...
						- And the last is “no source” (無源), a modern technical term meaning “passive device”, i.e., a device that does not require its own power supply (e.g., resistors, transformers)
						- 無源 in Dao De Jing
