		...
		- ((665359ff-79f1-4669-b10b-f2b0e633a7c1))
		  collapsed:: true
			- “Effect flow” versus causal chain, cause-and-effect chain (CEC), chain of causation
				...
				- In constrast to those linear “chains” of separate causes and effects which is like strings of beads, effect flow is a **dynamic continuum** , which is similar to the [dependent origination](https://en.wikipedia.org/wiki/Prat%C4%ABtyasamutp%C4%81da) principle, a.k.a. twelve-linked chain of conditions (dvādaśa-nidānāni, dvādaśa-hetupratyaya [十二因縁]).
