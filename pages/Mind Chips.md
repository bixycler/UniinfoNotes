...
- Projective relativity: the same content being viewed at different **viewpoints** on different **viewscales** results in different forms.   
  => Transformation = change of view = transcycling 
    - Viewpoint defines internal state; viewscale defines external world.
