		  ...
		  collapsed:: true
			...
			- I've just discovered that my [CreatZy Notes](https://creatzynotes.blogspot.com/) blog does not appear in Google Search anymore. The only result appear in Google Search as well as in other search tools by used chatbots is the very old post: [Spirorus, the structure of spacetime ;)](https://creatzynotes.blogspot.com/2013/08/spirorus-structure-of-spacetime.html)
			  collapsed:: true
				...
				- With Google Search Console's [URL inspection](https://search.google.com/search-console/inspect?resource_id=https%3A%2F%2Fcreatzynotes.blogspot.com%2F), the only indexed one is the “Spirorus” page: https://creatzynotes.blogspot.com/2013/08/spirorus-structure-of-spacetime.html
					- This seems to be triggered by the direct link from my GeoGebra [LightSpaceTimeCoords](https://www.geogebra.org/m/g7nuhfr6).
				- All other URLs are reported as "Sitemaps: No referring sitemaps detected" while these URLs do appear in the [sitemap.xml](((6880c5ca-c0e4-485c-ae5f-ef323dacd5df))).
				...
				- Reported reason for being not indexed
					...
					- [Page with redirect](https://support.google.com/webmasters/answer/7440203#page_with_redirect):
						...
						- After a month, [spirorus-structure-of-spacetime.html](https://creatzynotes.blogspot.com/2013/08/spirorus-structure-of-spacetime.html) has become unindexed due to this "redirect" issue (failed on Aug 11, 2025).
							...
							- In "Enhancements & Experience", the error [HTTP marked with canonical tag](https://support.google.com/webmasters/answer/11396518#errors) indicates that the `<link rel="canonical">` tag in pages served via HTTP has overridden HTTPS version – although they are identical!
				...
				- Model with GeoGebra: [TwistingDoubleI](https://www.geogebra.org/m/cexzy52b)
					...
					- Image & video & 3D model
						...
						- YouTube: [Twisting Double i – the “ï” of “Unïnfo”](https://www.youtube.com/shorts/evIXwWj9IFA)
						  id:: 698430b1-8693-444c-bee6-ae86f314c9f7
		  ...
		  collapsed:: true
			...
			- I saw the crutial key in my slavery is the **stack-based processing**.
			  id:: 690b3f49-1419-4dc3-b61b-12890b9e04f9
				- stack-based processing = order = hard constraint = caught up in action = ((6678d594-9819-4624-abd6-d4ec62b3874f)) with ((6846ca54-5e3a-4d49-b9e6-f2d8ad42ff00))
					- top down arrow = cause flow: input data, invocation control
					- bottom up arrow = effect flow: output data, returning control
					- Stack-frame order is caused by the **hard intents** generated by the ((681b3ad7-d1b0-4c06-a4ea-385a4a9314e0)).
