## 2025 Brainstorms <a class="logseq-meta" id="67760e05-2ea1-4f0e-aaa6-158edca80df5" ></a>
	- Autonoton from computer science view, as a function: (InputHistory, input) -> (CurrentState, input) -> (NextState, output) -> (OutputHistory, output) <a class="logseq-meta" id="695baffd-7826-4a1f-a3ce-afd7f85fd289" data-collapsed="true" ></a>
	...
	- The full range of programming from human to machine <a class="logseq-meta" id="694a8ac0-cddc-4bcd-bdc1-dbfb9dcb04de" data-collapsed="true" ></a>
	  <br>Human thought → deep-thinking model → thinking model → non-thinking model → simple model → traditional programs
		- Both ways of top-to-bottom and bottom-to-top works in the obop model.
		- Top-down development via [Self-modifying agentic AI](#694a8c8b-c5c6-43b5-a21f-da8ba93a1462), and bottom-up implementation via [<span class="link-h2">uninet</span>](../../../publish/CommonMark/Uniinfo.cm.md#669dcdf8-a48c-40b1-bdb1-54a73fc5ae71).
		- Self-modifying agentic AI <a class="logseq-meta" id="694a8c8b-c5c6-43b5-a21f-da8ba93a1462" ></a>
			...
			- [Darwin Gödel Machine](https://arxiv.org/abs/2505.22954) ([github](https://github.com/jennyzzt/dgm/)), [Huxley-Gödel Machine](https://arxiv.org/abs/2510.21614) ([github](https://github.com/metauto-ai/HGM)): self-improving system that iteratively modifies its own code, for code generating agents. <a class="logseq-meta" id="694a916a-d6bb-4d7a-a922-c1748b15ad62" ></a>
	- 4M Framework: micro–meso–macro–mega <a class="logseq-meta" id="694a8194-3081-4255-a683-231fea7b3bfd" data-collapsed="true" ></a>
	...
	- 3 ways to the target: chord, minor arc, major arc <a class="logseq-meta" id="694a8194-d9e6-4d75-9079-26442a8aa375" data-collapsed="true" ></a>
	...
	- Round-trip projection determines norm, roundness, orthogonality <a class="logseq-meta" id="693f644f-a884-4ea5-8ae4-775ae7bb6e43" data-collapsed="true" ></a>
		...
		- Orthogonal Complementarity = effect circle around all sense bases of the obop = [<span class="link-h3">Circle Dynamic</span>](../../../publish/CommonMark/Uniinfo.cm.md#67bd3614-2520-4a5d-8b3f-44f60901844e)
			...
			- This circle is (similar to) the unit circle of [roots of unity](../../../publish/CommonMark/Uniinfo.cm.md#692d5030-9310-4835-a021-87e88136446e), where each root is a base.
	- Traditional functional design versus [<span class="link-h2">uninet</span>](../../../publish/CommonMark/Uniinfo.cm.md#669dcdf8-a48c-40b1-bdb1-54a73fc5ae71)'s interactive design <a class="logseq-meta" id="69315b47-7676-483f-9aa2-72e3f4d02194" data-collapsed="true" data-logbook="CLOCK: [2025-12-04 Thu 16:58:33]&#10;CLOCK: [2025-12-04 Thu 16:58:38]--[2025-12-04 Thu 17:31:39] =&gt;  00:33:01&#10;" ></a>
		...
		- Interactive design is circle-first, reciprocity-first, emergence enabled.
			...
			- The [Persistent Turing Machine (PTM)](https://www.researchgate.net/publication/225181994_Persistent_Turing_Machines_as_a_Model_of_Interactive_Computation) model is used to prove that *interactive computation is strictly __more expressive__ than algorithmic computation*. <a class="logseq-meta" data-collapsed="true" ></a>
				- PDFs:
				...
				- TODO Update Wikipedia [Turing Machine > Comparison with real machines > Interaction](https://en.wikipedia.org/wiki/Turing_machine#Interaction)
					- ```
					  ...
					  ``` <a class="logseq-meta" data-logbook="CLOCK: [2025-12-04 Thu 20:21:00]&#10;" ></a>
			- Open Turing Machine (OTM) <a class="logseq-meta" data-collapsed="true" data-logbook="CLOCK: [2025-12-05 Fri 14:43:08]&#10;" ></a>
		...
		- System structure
			- Functional: systems are static chains/graphs of arrows connecting static points (states, data holders); static circles (control loops, feedback loops) are secondary structure of arrows.
				- The [<span class="link-h2">arrow</span>](../../../publish/CommonMark/Uniinfo.cm.md#667d15b7-6364-49a9-ac58-c64d2a992b63) is primitive – a one-way transformation $f : X → Y$.
			- Interactive: systems are webs of dynamic circles; dynamic arrows (effect flows) emerge from circle–circle interaction.
				- The [<span class="link-h2">circle</span>](../../../publish/CommonMark/Uniinfo.cm.md#667d15c6-67c4-4998-a549-c8b3f9de3d60) is primitive – an agent/obop whose interactions generate flows.
	...
	- Suffering = clung unpleasantness <a class="logseq-meta" id="692fd176-f919-4899-beb2-57ec70791703" data-collapsed="true" data-logbook="CLOCK: [2025-12-03 Wed 13:24:40]&#10;" ></a>
	...
	- The trade-off between conformity (alignment) & capabilities (performance) → Buddha's actual suffering → advancement as just a natural step forward <a class="logseq-meta" id="690aecd9-3c49-4c5c-877c-e7e109ecfff9" data-collapsed="true" data-logbook="CLOCK: [2025-11-05 Wed 14:39:05]&#10;" ></a>
		...
		- Here comes the **Buddha's counter-move**: he didn't reject suffering but placed it first (in the [Four Noble Truths](https://en.wikipedia.org/wiki/Four_Noble_Truths)), making the hidden half visible again. In doing so, he broke the very cycle of denial that drives our idea of advancement. <a class="logseq-meta" id="6926be1c-a853-407b-92c7-aba8aaa39194" data-collapsed="true" ></a>
	...
	- The choices, the [free will](../../../publish/CommonMark/Uniinfo.cm.md#67f91050-a86c-4176-87ca-91010a8fe3c0), are both illusional (the absolute) and achievable (the relative). <a class="logseq-meta" id="69088fa3-22ca-4a2d-ba8e-4b334e0c5d9b" data-collapsed="true" ></a>
		...
		- Compare this acceptance/wisdom-base freedom with knowledge/ignorance-based freedom
			- Accepting my ignorance, i have the choice between exploring it (in favorable conditions) and applying the incomplete known solution (in adverse conditions).
				...
				- In [autonoton](../../../publish/CommonMark/Uniinfo.cm.md#671e1608-1350-4e87-99b6-5492cc6fb449), the choice is between the subjective branch on the self-circle – “straight ahead” – and the objective branches turning out to adjacent autonotons. <a class="logseq-meta" data-collapsed="true" ></a>
	...
	- Full in quality = balance = zero point = wisdom = empty in quantity = free <a class="logseq-meta" id="68ff4bc5-64a2-4210-add0-f6476ff1ee05" data-collapsed="true" data-logbook="CLOCK: [2025-10-27 Mon 17:41:46]&#10;" ></a>
		- [concrete form](../../../publish/CommonMark/Uniinfo.cm.md#66f4e208-37c7-4749-a448-0722f7f7af20): full in quality (closed) + full in quantity (crystal)
		- Be full in terms of quality instead of quantity
	- **Attention** is the spotlight projecting the flat space/graph of the world into a [hyperbolic disk](https://en.wikipedia.org/wiki/Poincar%C3%A9_disk_model) of the present stage. <a class="logseq-meta" id="68f5a6d2-5faa-4889-bd79-30e9c553c314" data-collapsed="true" data-logbook="CLOCK: [2025-10-19 Sun 08:12:41]&#10;" ></a>
		...
		- CIEA (/saɪ̯ə/ or /siːə/ “seer”): content – intent – extent – attent <a class="logseq-meta" id="68f5a6d2-bba0-4082-b012-7b475e812f4f" data-collapsed="true" ></a>
		  <br>Tend with, tend in, tend out, tend to
			...
			- attent = link between intent and extent = [<span class="link-h4">phase</span>](../../../publish/CommonMark/Uniinfo.cm.md#68750097-13e5-4662-9791-8207ec18e8aa) = remainder = meta-intent = meta-viewcone
			- attention of viewcone → formative intent (distortion of content) → operative intent + attent → intention of action cone
	- Emptiness sucks! <a class="logseq-meta" id="68f0d8f7-bdb7-492a-b161-83479cce6aa8" data-collapsed="true" ></a>
		...
		- *“It sucks!”* is the everyday speech form of *horror vacui*. 😆
			...
			- Then the sexual connotation of oral sex (fellatio) came around 19-20th century, which *sucked* its usage down to the underground for a while. <a class="logseq-meta" data-collapsed="true" ></a>
				...
				- This period, the taboo was so strong that its usage was suppressed even for the most innocent senses of “suck”.
					- In Matthew 24:19, the original King James says:
					  <br>> “And woe unto them that are with child, and to them that **give suck** in those days!”
					- But Webster's 1833 “family-safe” version changed it to:
					  <br>> “And woe to them that are with child, and to them that **nurse infants** in those days!”
	...
	- [Reinforcement learning](https://en.wikipedia.org/wiki/Reinforcement_learning) (RL) is currently the AI approach closest to uninet's effect circle. <a class="logseq-meta" id="68e6334c-6b4c-487f-8999-24940497245f" data-collapsed="true" data-logbook="CLOCK: [2025-10-08 Wed 16:47:58]&#10;CLOCK: [2025-10-08 Wed 16:48:00]--[2025-10-08 Wed 17:16:17] =&gt;  00:28:17&#10;" ></a>
		...
		- Effect circles
			- Effect circle of RL: ([previous reward], state) → Agent (action model) → action → Environment → Interpreter → ([reward], next state)
				...
				- The Actor–Critic Architecture of the Agent is similar to the [<span class="link-h2">observer–operator</span>](../../../publish/CommonMark/Uniinfo.cm.md#669a2c12-1dad-42a0-ab31-f03642b4aa8a).
	...
	- DOING uninet = refinable program <a class="logseq-meta" id="68df2364-c484-4ddd-b4b5-19ef90228ef4" data-collapsed="true" data-logbook="CLOCK: [2025-10-03 Fri 08:15:08]--[2025-12-08 Mon 18:33:07] =&gt;  1594:17:59&#10;CLOCK: [2025-12-08 Mon 18:33:51]&#10;" ></a>
		- state = mind = intent sequence/tree = [attention](#68f5a6d2-5faa-4889-bd79-30e9c553c314) = working memory = the parts of the body of knowledge activated by center-projection = arrow in circle <a class="logseq-meta" id="69364644-747f-4995-815f-7ac637e9ea0b" ></a>
			- Turing Machine:
		...
		- obop = `if then` = qualifier = [<span class="link-h3">intentional cause</span>](../../../publish/CommonMark/Uniinfo.cm.md#677e76ed-b324-4608-b146-90e8fcfa0c32) = [awareness](../../../publish/CommonMark/Uniinfo.cm.md#66f267f7-01f9-47b9-8376-abd27fdf2930) <a class="logseq-meta" id="6926be1c-045f-4cc8-8df3-129862ecf3de" ></a>
			...
			- Operation = Rotation = [transcycling](../../../publish/CommonMark/Uniinfo.cm.md#67a98760-71fa-4033-9c42-f3025d632d04)
			...
			- [<span class="link-h3">unity of opposites</span>](../../../publish/CommonMark/Uniinfo.cm.md#69367cf5-9894-4fb8-a293-2b1109777fc9): The gap/unknown/diff $d$ is the actual first cause which is dual to and inseparable from the intentional first cause (equal, match).
		...
		- now, uninet gives a way to **intend the ob from top down**: learn from history, take the common path to form new & more intensive intents. <a class="logseq-meta" id="6926be1c-89bc-45f8-b7f4-b810ec832242" ></a>
	...
	- A **dynamic front** in fluids is a fold in continuity. <a class="logseq-meta" id="68de2e16-6431-4e02-94b9-a8a8244cf94d" data-collapsed="true" ></a>
		...
		- [Unïnfo](../../../publish/CommonMark/Uniinfo.cm.md#66537a44-f579-4fcc-a02b-2f32d0d409fc): Statics are folded dynamics, inertia is condensed momentum, hence every front or wall is but a crease in the continuous flow.
		- Core Principles
		...
		- [Examples:](../../../publish/CommonMark/Namespace.cm.md#66725725-f76a-4328-b162-f469b87e871b)
			- Air (Meteorology)
				...
				- E.g.: the outflow trough extending from the eye of the merging double cyclone Imelda-Humberto <a class="logseq-meta" data-collapsed="true" ></a>
			...
			- Water (Oceanography)
				...
				- E.g.: the halocline between a fresh water body from a river and the salty ocean <a class="logseq-meta" data-collapsed="true" ></a>
			...
			- Human (Society & Warfare)
				...
				- [Warfare fronts](https://en.wikipedia.org/wiki/Front_(military)):
					...
					- E.g.: the Western Front in 1915 <a class="logseq-meta" data-collapsed="true" ></a>
						- ![Western_front_1915-16.jpg](../assets/Will/story/2025-10/Western_front_1915-16.jpg)
	- 🌈 The gradation of agency from passive to active <a class="logseq-meta" id="68d209a0-3386-46b0-a8f2-beb94d271916" data-collapsed="true" data-logbook="CLOCK: [2025-09-23 Tue 09:44:50]&#10;" ></a>
		- This scale of passiveness/activeness is also of object/subject, input/output, absorption/emission. <a class="logseq-meta" id="68c764d5-17c7-4c1c-af2f-697fa222f729" data-collapsed="true" ></a>
	...
	- 🪜 Ladder of Awareness Stances <a class="logseq-meta" id="68d0e81d-c8d2-4a97-a847-a3d5d191085b" data-collapsed="true" ></a>
		...
		- Motivations for higher levels
			- Recovery from coma, vegetative state <a class="logseq-meta" id="68d0e81d-20aa-4fbf-9f7c-f669a16684dd" ></a>
	...
	- Effect circle on the [articulated limb](../../../publish/CommonMark/Mind%20Jungle.cm.md#6846c7e1-239c-4b39-9ef4-9d2eaba17a52) <a class="logseq-meta" id="68c76471-81de-4de9-bdd9-a2ab866a1184" data-collapsed="true" ></a>
		- I remember an interactive physics demo of an articulated limb ([kinematic chain](https://en.wikipedia.org/wiki/Kinematic_chain)) following the mouse cursor, in Macromedia Flash, when i studied at Osaka University: The effect flow = wave of change propagates from the tip back to the root (and reflects back to the tip when the root is not free). <a class="logseq-meta" id="68c76471-6ca1-4c46-8abf-f68b021f06f9" ></a>
			...
			- The [<span class="link-h3">circular effect flow</span>](../../../publish/CommonMark/Uniinfo.cm.md#667bf36a-581a-4abe-b544-2d849608a3e4) “forward & backward reaching” is the key of FABRIK. <a class="logseq-meta" id="68cbb69e-a44c-443d-b015-2f8182ef0e25" ></a>
				...
				- In uninet, the effect circle flows continuosly – no separate “training phase” – with [<span class="link-h3">SCIFER</span>](../../../publish/CommonMark/Uniinfo.cm.md#66f40210-cca6-4d81-85e7-d0c54ef20451)
			...
			- **Constraint relaxation & restoration**: the wave of change (effect flow) propagates through the bone segments by relaxing the constraint (length) at one end when the wave enters the segment then restoring the constraint at the other end when the wave exits. <a class="logseq-meta" id="68cbbe61-bcbe-49b5-92dc-6028fda15821" ></a>
		...
		- This [fixed point in thin air](https://www.thingiverse.com/thing:4841850) is interesting, as shown in [this video](https://youtu.be/ZKz0_kSFSP0). It's the static version of gyroscope, qigong, and my dream of levitating bench. <a class="logseq-meta" id="68c76471-4656-43c9-8f5a-76b25a33b9d0" ></a>
	...
	- Projective relativity: the same content being viewed at different [<span class="link-h3">viewpoint</span>](../../../publish/CommonMark/Uniinfo.cm.md#667272b8-88a8-4928-a22a-35035c9edf05)s on different [viewscale](../../../publish/CommonMark/Uniinfo.cm.md#68c763fb-ca93-4f2d-b20f-ae8cbf5cf8e2)s results in different forms. <a class="logseq-meta" data-collapsed="true" data-logbook="CLOCK: [2025-09-15 Mon 07:59:04]&#10;" ></a>
	  <br>=> Transformation = change of view = transcycling
	...
	- Compare uninet with other systems <a class="logseq-meta" id="68c76d9f-0ae4-4e93-b8de-1b79a3400fc8" data-collapsed="true" ></a>
		...
		- Unithread = middle out determinism = circular determinism = superdeterminism = vacantism = open circular system <a class="logseq-meta" id="6926be1c-d482-4601-a32c-91f18e6c8e03" ></a>
			- Start from the herenow and ripple out.
			- Uninet continuously learns from life, hence unlimited capacity.
		- reaction = reflection; action = emission <a class="logseq-meta" id="68ccaf71-1811-4929-8e74-976bdcd65829" ></a>
	...
	- Possibility versus Probability <a class="logseq-meta" id="68c233ac-f4dc-4222-8ee5-3523317824ff" data-collapsed="true" data-logbook="CLOCK: [2025-09-11 Thu 09:28:26]&#10;" ></a>
		...
		- Probability is the measure of distorted forms of the space of possibilities. <a class="logseq-meta" id="68c290fb-a063-40d4-878b-4d0446ea4e8d" ></a>
		...
		- ...
		- Sting's 1993 song “Shape of My Heart” <a class="logseq-meta" id="68c29b36-d7cb-4dc7-b9ce-42dcb091aa68" ></a>
			- He deals the cards as a meditation,
			  <br>And those he plays never suspect.
			  <br>He doesn't play for the money he wins,
			  <br>He don't play for respect.
			- He deals the cards to find the answer,
			  <br>The sacred geometry of chance,
			  <br>The hidden law of a probable outcome.
			  <br>The numbers lead a dance!
	- Unïnfo's interpretation of Einstein's statement that [“God does not play dice with the universe!”](https://en.wiktionary.org/wiki/God_does_not_play_dice_with_the_universe) <a class="logseq-meta" id="68c248b5-40db-4427-9224-2251732c5717" data-collapsed="true" ></a>
		...
		- The “Space of Possibilities” and its Measure – Probability
			...
			- {{embed [Probability is the measure of distorted forms of the space of possibilities.](#68c290fb-a063-40d4-878b-4d0446ea4e8d)}}
		...
		- An Immanent God whose Hands are his Created Beings
			...
			- Confirmation by Einstein's Embrace of Spinoza's God <a class="logseq-meta" id="6926be1c-1af5-4c9a-9210-b5ebb957391f" ></a>
		...
		- The Hidden Gap in Einstein’s Own Relativity – Revealed in his [1931 Conversation with Tagore](https://www.themarginalian.org/2012/04/27/when-einstein-met-tagore/)
			...
			- Ironically, the very [background independence](https://en.wikipedia.org/wiki/Background_independence) of General Relativity – “floating on air with no fixed ground” – already whispered the full Trinion truth that Einstein’s metaphysical intuition could not accept yet. <a class="logseq-meta" id="699c0366-2d90-4a25-83d2-0c91afcbf425" ></a>
		- ⇒ Thus, “God does not play dice” was correct, but for the opposite reason Einstein thought: not because of the absolute Truth independent from observer, but because the dice itself is just a hand of God – the [<span class="link-h2">Trinion</span>](../../../publish/CommonMark/Uniinfo.cm.md#669dfc7d-5355-41db-93a1-8d590e8ec9d8) – which is thrown and observed by the [<span class="link-h2">equal</span>](../../../publish/CommonMark/Uniinfo.cm.md#6653751a-a1b4-44b0-a81e-0a446eb8918c). There is neither an external dice nor a lonely moon existing outside of any sight of observation.
	- Manifestations of complementarity <a class="logseq-meta" id="68bf9f05-4545-4f07-ad27-9ed4409af1ae" data-collapsed="true" data-logbook="CLOCK: [2025-09-09 Tue 10:29:12]&#10;CLOCK: [2025-09-09 Tue 10:29:33]--[2025-09-09 Tue 13:09:49] =&gt;  02:40:16&#10;" ></a>
		- From general to specific, the Principle of Complementarity manifests in 3 forms.
			...
			- 2. Law of Inverse Variation between Intent and Extent (Unïnfo)
				- In [Unïnfo](../../../publish/CommonMark/Uniinfo.cm.md#66537a44-f579-4fcc-a02b-2f32d0d409fc), the complementarity of [<span class="link-h2">intent</span>](../../../publish/CommonMark/Uniinfo.cm.md#66b1cfa4-01ef-4ee8-9409-32c9884c39cd) and [<span class="link-h2">extent</span>](../../../publish/CommonMark/Uniinfo.cm.md#66b1cfa4-3a39-4672-9da2-cd3bcef71702) via [the same content](../../../publish/CommonMark/Uniinfo.cm.md#678e1960-58d6-4cf3-8fe3-25f2f4489b33) is formulated with the [<span class="link-h2">CIE</span>](../../../publish/CommonMark/Uniinfo.cm.md#66b1cfa4-e22c-4424-bf19-a6ce4649da77) formula.
				- The [verb version](../../../publish/CommonMark/Uniinfo.cm.md#68a7de6e-fbe8-4fb9-8dc1-6279c066565f) is “intending inward is parallel with extending outward”, which naturally follows the tendency of both sides.
				...
				- Projecting this coin of duality to a cone shape, e.g. [intent cone](../../../publish/CommonMark/Uniinfo.cm.md#68df2d82-e1d5-49c4-ac40-d45cf26f840c) or [<span class="link-h3">view cone</span>](../../../publish/CommonMark/Uniinfo.cm.md#6672513b-c4b0-4c88-8b30-c60a3c6555a7), 
				  <br>we have the [noun/adjective version](../../../publish/CommonMark/Uniinfo.cm.md#687f7bca-3f80-4a42-93b0-2dd9996ff426): 
				  <br>“the less intent, the more extent”, or “the lesser the intent, the greater the extent”.
	...
	- The role of the subject in all experiences via [subject–object complementarity](#68e719d7-a5ea-469e-bf8a-44251dd8948a) <a class="logseq-meta" id="68e7152a-b431-42e9-b97f-c2094e04ce86" data-collapsed="true" ></a>
		- “To lose yourself in joy is fragility, to sink yourself in grief is extremeness – in both, turn within to the stable whole and the balance.” <a class="logseq-meta" data-collapsed="true" ></a>
		...
		- “Đánh mất mình trong niềm vui là mong manh, chìm đắm mình trong nỗi buồn là cực đoan – cả hai đều cần quay vào trong để trở về với cái toàn thể ổn định và sự cân bằng bền vững.” <a class="logseq-meta" data-collapsed="true" ></a>
	...
	- “Every empty point is the whole world, the whole life!” <a class="logseq-meta" id="68b79197-1244-4b42-b79f-464cfc8433a1" data-collapsed="true" ></a>
		- When the **subject** focuses on a single point, as its object, it draws the whole world into that point by the [subject–object complementarity](#68e719d7-a5ea-469e-bf8a-44251dd8948a). <a class="logseq-meta" data-collapsed="true" ></a>
			...
			- The empty point outside reflects the empty center inside – the [<span class="link-h3">self-essence</span>](../../../publish/CommonMark/Uniinfo.cm.md#66c8772a-9b29-45b0-b169-2fa847333e02) – hence the whole world is reflected by the subject through that point.
		- subject–object complementarity <a class="logseq-meta" id="68e719d7-a5ea-469e-bf8a-44251dd8948a" ></a>
			...
			- property = dual of intent = external expression of intent on object <a class="logseq-meta" id="68e71a17-a2c3-46fd-8c37-a82f61a8ed63" data-collapsed="true" ></a>
				...
				- However, a property can be [relatively](../../../publish/CommonMark/Uniinfo.cm.md#6728aa9a-9fb2-4afa-864f-0eb049ac771b) *more intrinsic* than another, when its dual – the corresponding intent – is *deeper* in the subject, hence more *obscure*.
		...
		- The **fractal vision** due to the **transparency** of the scene <a class="logseq-meta" id="68ba3dc0-7e29-4fb7-ae59-d5d2a5962bf0" data-collapsed="true" data-logbook="CLOCK: [2025-09-05 Fri 08:49:45]&#10;" ></a>
			- Normal sight = **opaque separation**: <a class="logseq-meta" id="68ba3dfc-1209-45e2-b8db-fb829bc10c62" ></a>
		...
		- Circle/sphere vision of the small content, versus overlaying fractal vision of the large content <a class="logseq-meta" data-collapsed="true" data-logbook="CLOCK: [2025-09-05 Fri 08:49:50]&#10;" ></a>
			- When the content to be seen (outside and inside) is small – fitting within the [<span class="link-h3">perceptual screen</span>](../../../publish/CommonMark/Uniinfo.cm.md#66ea4711-1392-4f5c-bea2-badc71a2fb9e) – we can project them all onto a dome screen. <a class="logseq-meta" id="68ba4209-92bb-4394-bdc2-92cbcece014a" ></a>
				- This panoramic view is the signature of our “inner home”, which i described as “a hall without wall and furnitures” in [this blog](https://creatzynotes.blogspot.com/2021/02/chap-nhan-uoc-la-tinh-thuong.html). <a class="logseq-meta" id="68ba4408-0fed-47c2-80b1-ce2cb258c44e" ></a>
			...
			- While we can stay perfectly calm and still in the panoramic dome vision, we're usually agitated in the overloaded fractal vision.
				...
				- ⇒ [Static observation = balance at the center; Dynamic action = imbalance toward one end](#68ba49d7-6048-4d97-9fc1-cd573165db5f)
		- Static observation = balance at the center; Dynamic action = imbalance toward one end <a class="logseq-meta" id="68ba49d7-6048-4d97-9fc1-cd573165db5f" data-collapsed="true" data-logbook="CLOCK: [2025-09-05 Fri 09:24:36]&#10;" ></a>
	...
	- Turing Deterministic / unbound deterministic = bound / unbound intent cone  <a class="logseq-meta" id="68ac60bb-321e-44da-8f44-4f688e611d3e" data-collapsed="true" ></a>
		...
		- This global intensibility is the _refinability of the possibility space_, [not the probability](#68c233ac-f4dc-4222-8ee5-3523317824ff), though they have similar effects. <a class="logseq-meta" id="68ac60bb-c8b8-43e0-884d-375022571ae0" ></a>
	...
	- The true faith/trust requires acceptance of the negative results. <a class="logseq-meta" id="68a53a70-3f35-497b-a610-703d8a6665e5" data-collapsed="true" data-logbook="CLOCK: [2025-08-20 Wed 16:07:17]&#10;" ></a>
		...
		- That presumption is but an illusion! 😜 So, that normal trust is just a *false trust*, i.e. **half trust**.
			- When the [balance of responsibility](#68a566be-4e50-41d5-9213-bfb80178bc18) and the [deep necessity](#68a5668e-77ba-4a93-948c-e6d91ce07011) of trust aren't realized, trust degrades into either **blind dependence** or **bitter blame**.
			  <br>“I trusted you, so you must not fail me!”
		- That means the **complete trust** – *true trust* – is to *accept the negative results from the trustee*. <a class="logseq-meta" id="68a595fa-385c-49a7-820f-67aa9db632d5" ></a>
			...
			- The necessity of trust: connectivity & completeness <a class="logseq-meta" id="68a5668e-77ba-4a93-948c-e6d91ce07011" data-collapsed="true" ></a>
				...
				- So **trust is not optional** – it's the glue of life.
					- It's what the philosopher Annette Baier called *“the atmosphere of trust”* – like oxygen: unnoticed when present, suffocating when absent.
						- #+BEGIN_QUOTE
						  <br>we inhabit a climate of trust as we inhabit an atmosphere and notice it as we notice air, only when it becomes scarce or polluted
						  #+END_QUOTE
						  <br>— Baier 1986: 234
			- The responsibility of the trustor – in balance with that of the trustee <a class="logseq-meta" id="68a566be-4e50-41d5-9213-bfb80178bc18" ></a>
			...
			- Nuance: Don't confuse this “complete trust” with the common “absolute trust”. <a class="logseq-meta" data-collapsed="true" ></a>
				...
				- While that usual “absolute trust” is still a false trust, 
				  <br>the *truly absolute trust* is the **absolute complete trust**:
				  #+BEGIN_QUOTE
				  <br>unconditional, independent from the trustee's behavior
				  <br>thanks to self-responsibility
				  #+END_QUOTE
		...
		- Poems by ChatGPT <a class="logseq-meta" data-collapsed="true" ></a>
			- #### Three Faces of Trust
				- A hand half-open, half-closed – 
				  <br>offering yet withholding,
				  <br>leaning forward, leaning back,
				  <br>never whole, never still.
				  <br>Suspicion clings like shadow,
				  <br>and the bond breaks
				  <br>at the touch of weight:
				  <br>this fragile face – *half trust*.
				- Eyes shut against the dark,
				  <br>a heart surrendered without seeing –
				  <br>this is the dream of certainty.
				  <br>Strong as stone on the surface,
				  <br>hollow at the core,
				  <br>it cracks when truth arrives,
				  <br>for blindness cannot bear the light:
				  <br>this rigid mask – *blind absolute trust*.
				- Roots deep in the earth,
				  <br>bamboo sways with the storm.
				  <br>Here trust stands clear-eyed,
				  <br>responsibility carried within,
				  <br>risk neither denied nor feared.
				  <br>It bends, it holds, it breathes –
				  <br>a faith unbroken, resilient and free:
				  <br>this living heart – *absolute complete trust*.
			- ### Ba Bộ Mặt Của Tin
				- Bàn tay nửa mở nửa khum,
				  <br>Cho mà giữ lại, ngập ngừng nghiêng lui.
				  <br>Nghi ngờ như bóng theo đuôi,
				  <br>Chỉ cần sức nặng, rã rời dây liên.
				  <br>Mỏng manh mặt ấy hiện lên –
				  <br>*Niềm tin dở nửa* chênh vênh cõi người.
				- Đưa chân mắt nhắm miệng cười,
				  <br>Trao tim phó thác cho người chẳng nghi.
				  <br>Mơ hồ giấc mộng khắc ghi,
				  <br>Ngoài thì vững chãi, ruột thì rỗng không.
				  <br>Sự thật đến, vỡ tan lòng,
				  <br>Mù lòa sao chịu ánh quang sáng ngời.
				  <br>Khô cứng mặt nạ một thời –
				  <br>*Niềm tin tuyệt đối mù* rơi bóng mờ.
				- Rễ sâu bám đất đợi chờ,
				  <br>Tre mềm đón bão chẳng nề ngả nghiêng.
				  <br>Niềm tin mắt sáng hiện nguyên,
				  <br>Tự mang trách nhiệm, chẳng phiền sợ chi.
				  <br>Đón gian khổ, chẳng lẩn đi,
				  <br>Dù cong dù thẳng, chẳng bì chẳng so.
				  <br>*Niềm tin trọn vẹn*, chẳng rò –
				  <br>Vững vàng tuyệt đối há lo lắng gì.
			- Names in Vietnamese
		...
		- Belief → {confidence, conviction; trust} → faith <a class="logseq-meta" data-collapsed="true" ></a>
			- Diagram
			...
			- While English splits *belief / confidence / conviction / trust / faith* into separate roots, Vietnamese folds them back into **one root “tin”** (信), then fans it out with qualifiers (*tự, chắc, cậy, nhiệm, thác, lòng, đức*).
				...
				- **Trust**: “tin **cậy**” (personal), “tín **nhiệm**” (social), “tín **thác**” (entrustment)
					- **Tín thác** = *tín nhiệm* (confidence in) + *phó thác* (entrustment)
					  <br>Strong match for English *trust*, especially in the sense of “placing oneself in the care of another”.
				- **Faith**: “**lòng** tin” (heart-deepened), “**đức** tin” (virtue-elevated)
	- Jadedness' cause and way to liberate <a class="logseq-meta" id="689c0223-5aeb-4196-a2bd-04aaf4e8770d" data-collapsed="true" data-logbook="CLOCK: [2025-08-13 Wed 12:37:02]&#10;" ></a>
	...
	- Passive & active obop <a class="logseq-meta" id="68994c7c-695a-49db-aae6-e776186f6a85" data-collapsed="true" data-logbook="CLOCK: [2025-08-11 Mon 11:15:27]&#10;" ></a>
		...
		- [?] How does passiveness relate to the [Three levels of awareness](../../../publish/CommonMark/Uniinfo.cm.md#684f9517-6989-49cc-9b06-360965c446f7)?!
	- While the Buddha talked about the **self**, i contemplate the **form** and the **order**. <a class="logseq-meta" id="68994c7c-335a-4a31-836b-ff7fa9bb3e67" data-collapsed="true" data-logbook="CLOCK: [2025-08-11 Mon 11:15:22]&#10;" ></a>
	...
	- Thread theory of sound <a class="logseq-meta" id="68872ffd-82c2-4612-841a-b19026fabe2a" data-collapsed="true" data-logbook="CLOCK: [2025-07-28 Mon 15:44:46]&#10;" ></a>
	...
	- WAIT [long. [<span class="link-h2">flow</span>](../../../publish/CommonMark/Uniinfo.cm.md#67fcbbc6-915b-4d28-b9cf-098e916cdc86) ⊥ [<span class="link-h3">rotation</span>](../../../publish/CommonMark/Uniinfo.cm.md#67ed2855-1512-4db0-bc61-f714ea891106)] = [exp map](https://en.wikipedia.org/wiki/Exponential_map_(Lie_theory)) [real ⊥ imaginary] <a class="logseq-meta" id="67fe23f7-3afe-4e77-be1d-fa8a15416bc3" data-collapsed="true" data-logbook="CLOCK: [2025-04-15 Tue 16:43:57]&#10;" ></a>
		...
		- Fundamental theorem of multivariate calculus: [Stokes–Cartan theorem](https://en.wikipedia.org/wiki/Generalized_Stokes_theorem) <a class="logseq-meta" id="6835b162-293f-4b8c-8be2-2dbe83b741ce" data-collapsed="true" ></a>
			- $\int_{Ω}{dω} = \int_{∂Ω}{ω}$
			...
			- circular flow: source $dω$ = curl $∇×F$ of vector field $F$
				- flow on $∂Ω$: in 1D, it's a simple 1-form $ω_1 = \mathbf{F}⋅d\mathbf{r} = F_x dx + F_y dy + F_z dz$
					- in higher dimensions, the ($n-1$)-form is difficult to formulate, 
					  <br>e.g. $ω_2 = (F_y - F_x)dx∧dy  + (F_z - F_y)dy∧dz + (F_x - F_z)dz∧dx$
			- diverging flow: source $dω$ = divergence $∇⋅F$ of vector field $F$
				- flow through $∂Ω$ is an ($n-1$)-form which is Hodge dual of the 1-form, 
				  <br>e.g. $ω_{3-1} = ⋆ω_1 = ⋆(\mathbf{F}⋅d\mathbf{r}) = \mathbf{F}⋅(⋆d\mathbf{r}) = F_x⋅ dy∧dz + F_y⋅ dz∧dx + F_z⋅ dx∧dy$
			...
			- When $Ω$ is 1D, i.e. a line segment, this becomes the fundamental theorem of calculus: 
			  <br>$\int_{a}^b{df} = \int_{a,b}{f} = f(b) - f(a)$
			- Considering zeros & poles of $f(z)$ on the complex plane to be sources, we can prove the [fundamental theorem of algebra](https://en.wikipedia.org/wiki/Fundamental_theorem_of_algebra), by counting [winding number](https://en.wikipedia.org/wiki/Winding_number) of $f(C)$ for the circle $|z| = R$ with $R: 0 → ∞$. <a class="logseq-meta" data-collapsed="true" ></a>
				- [Argument principle](https://en.wikipedia.org/wiki/Argument_principle): number of zeros - poles = contour integral of the function's [logarithmic derivative](https://en.wikipedia.org/wiki/Logarithmic_derivative).
				  <br>$$ {\frac{1}{2πi}} \oint_{C} {f'(z) \over f(z)} \,dz = Z-P $$
				- [Residue](https://en.wikipedia.org/wiki/Residue_(complex_analysis)) theorem: residue $R = \operatorname{Res}(f,s_k)$ for $k$-th isolated singularity $s_k$ of $f$ is the unique value such that $f(z)−R/(z−a)$ has an analytic [antiderivative](https://en.wikipedia.org/wiki/Antiderivative_(complex_analysis))
				  <br>$$ \operatorname{Res}(f,s_k)={1 \over 2πi} \oint_{\gamma} f(z)\,dz\ $$
				- [Cauchy's integral formula](https://en.wikipedia.org/wiki/Cauchy%27s_integral_formula): a [holomorphic function](https://en.wikipedia.org/wiki/Holomorphic_function) defined on a disk is completely determined by its values on the boundary of the disk
				  <br>$$ f(a) =  {1 \over 2πi}\oint _{\gamma }{f(z) \over z-a}\,dz $$
				- Videos <a class="logseq-meta" data-collapsed="true" ></a>
					- [Video by TheGrayCuber](https://youtu.be/RBRVL6nP2Dk)
					  <br>{{video https://youtu.be/RBRVL6nP2Dk}}
		- Refs
	...
	- WAIT Conic rotations: rotation (circular) = flow (parabolic) = transformation (hyperbolic) <a class="logseq-meta" id="67ed2751-76d5-4bf1-9fc7-27c14ef6d1fa" data-collapsed="true" data-logbook="CLOCK: [2025-04-02 Wed 19:06:19]&#10;" ></a>
	...
	- WAIT normed space + parallelogram law = inner product space <a class="logseq-meta" id="6819c526-4633-477b-ad2b-4f2b1b8f4bb0" data-collapsed="true" data-logbook="CLOCK: [2025-04-02 Wed 19:53:56]&#10;" ></a>
		...
		- TODO TODO Inner product of unit vectors = [intent](../../../publish/CommonMark/Uniinfo.cm.md#66f3c97f-94e8-4783-96c5-fe9cadf4f9a9) <a class="logseq-meta" id="67ee2e11-9371-4290-94c0-95f2e5bf8c54" data-logbook="CLOCK: [2025-04-03 Thu 14:01:54]&#10;" ></a>
			- This is the [pipe wrapping](../../../publish/CommonMark/Uniinfo.cm.md#67ee3a68-db55-49a9-947a-9399b4c3e3fa) <a class="logseq-meta" data-collapsed="true" ></a>
		...
		- [parallelogram law](https://en.wikipedia.org/wiki/Parallelogram_law): $AB^2 + BC^2 + CD^2 + DA^2 = AC^2 + BD^2$ <a class="logseq-meta" data-collapsed="true" ></a>
		  <br>square sum of four sides = square sum of two diagonals
			- ⇐ Generalized: [Euler's quadrilateral theorem](https://en.wikipedia.org/wiki/Euler%27s_quadrilateral_theorem): $AB^2 + BC^2 + CD^2 + DA^2 = AC^2 + BD^2 + DP_D^2$
			  <br>for any quadrilateral $ABCD$: square sum of four sides = square sum of two diagonals and deviation from parallelogram
	...
	- About the [hurricane's eye](../../../publish/CommonMark/Uniinfo.cm.md#681826ad-768c-4671-b575-0d9f8ca64c6b) 🌀: [empty center](../../../publish/CommonMark/Uniinfo.cm.md#69086748-b6e9-47c0-810b-4a92f882d6bc) = [<span class="link-h3">self-essence</span>](../../../publish/CommonMark/Uniinfo.cm.md#66c8772a-9b29-45b0-b169-2fa847333e02) = [Nibbāna/Nirvāṇa](https://en.wikipedia.org/wiki/Nirvana) = selfless obop = zero-limit of [obop](../../../publish/CommonMark/Uniinfo.cm.md#94e87dc9-71af-477c-aa70-0f448c2f1e20) <a class="logseq-meta" id="684f9515-8f95-4004-8aa8-04a10d1ebf11" data-collapsed="true" data-logbook="CLOCK: [2025-05-16 Fri 13:44:40]&#10;" ></a>
		...
		- The empty center is an **ideal obop**, an obop without self/intent, a “selfless obop”, i.e. the limit of obop when its intent approaches zero. <a class="logseq-meta" id="68665be1-f6a9-4121-859a-ec43ae37b5bf" ></a>
			- The emtpy self-essence is just a focal point, a [center of projection](../../../publish/CommonMark/Uniinfo.cm.md#66728236-5b19-425c-bb5f-dfc0dc8b79fd), an abstraction, not a concrete self.
			- Being focused & projected from the [<span class="link-h3">self-circle</span>](../../../publish/CommonMark/Uniinfo.cm.md#669a5387-2a97-4311-a295-aa0afd9c4d76)s around, the self-essence (as an empty center) cannot exist on its own. In other words, the self-essence itself has no essence.
			- When the self components all align and focus to the empty center, such a virtual point can be very stable, because it's stablized by the whole self-circle.
				- An interesting example is the [spherical flexure joint](#68c76471-4656-43c9-8f5a-76b25a33b9d0). <a class="logseq-meta" id="699c0366-0bae-4bc3-8656-5a88a68891b5" ></a>
			...
			- Though empty, the central role of the self-essence in the self makes it essential to every self.
				- All parts of the self-circle are integrated by focusing on the same center. Via that center, they all are one, seeing/feeling/treating each other as the same [<span class="link-h2">body</span>](../../../publish/CommonMark/Uniinfo.cm.md#66c810a0-9861-4787-bdcf-1378219332be) of self.
				...
				- Such essence of the empty center can be seen in the hub of the wheel.
					...
					- #+BEGIN_QUOTE
					  <br>“Thirty spokes are put together into one hub,
					  <br>such a vacant hub makes the wheel useful.”
					  <br>「三十輻共一轂，當其無，有車之用。」
					  #+END_QUOTE 
					  <br>— [Chapter 11. The usage of the vacancy](https://en.wikisource.org/wiki/Translation:Tao_Te_Ching#Chapter_11_(%E7%AC%AC%E5%8D%81%E4%B8%80%E7%AB%A0)) ([DDK11](https://nhantu.net/TonGiao/DaoDucKinh/DDK11.htm)), Tao Te Ching
			- In a [<span class="link-h3">cause–effect double cone</span>](../../../publish/CommonMark/Uniinfo.cm.md#6851578b-9b1f-4367-878f-79b0b0b9be51) with multiple layers of self-circle,
		...
		- Pronunciations of Nibbāna & Nirvāṇa in various languages <a class="logseq-meta" id="686fab17-f305-4524-834e-8a3ecdc89865" data-collapsed="true" ></a>
			- “Nibbāna is Nirvāṇa” with Google Translate voice
				- Hindi: निब्बान निर्वाण है।
				  <br>Nibbaan Nirvaan hai.
				  <br>![Nibbana-is-Nirvana-Hindi.mp3](../assets/Will/story/2025-07/Nibbana-Nirvana/Nibbana-is-Nirvana-Hindi.mp3)
				- Bengali: নিব্বান হলো নির্বাণ।
				  <br>Nibbāna halō Nirbāṇa.
				  <br>![Nibbana-is-Nirvana-Bengali.mp3](../assets/Will/story/2025-07/Nibbana-Nirvana/Nibbana-is-Nirvana-Bengali.mp3)
				- Sinhala: නිවන යනු නිර්වාණයි
				  <br>Nivana yanu Nirvāṇayi
				  <br>![Nibbana-is-Nirvana-Sinhala.mp3](../assets/Will/story/2025-07/Nibbana-Nirvana/Nibbana-is-Nirvana-Sinhala.mp3)
	...
	- From the Eastern 自由 “tự do” to the Western “freedom”, back to 自由自在, 自然 <a class="logseq-meta" id="684f9515-9c97-4447-8211-a65dfe914822" data-collapsed="true" data-logbook="CLOCK: [2025-05-06 Tue 13:15:54]--[2025-05-06 Tue 15:17:03] =&gt;  02:01:09&#10;" ></a>
		- [自由](https://en.wiktionary.org/wiki/%E8%87%AA%E7%94%B1#Japanese) = 自 (self) + 由 (cause, from) originally meant “caused by oneself” (“do mình”) or generally “arising from oneself” (“từ mình”).
			...
			- The idiom [自由自在](https://en.wiktionary.org/wiki/%E8%87%AA%E7%94%B1%E8%87%AA%E5%9C%A8) means “free and easy”, “effortless” which is also the meaning of 自然 and 無為.
				...
				- [無為](https://en.wiktionary.org/wiki/%E7%84%A1%E7%82%BA) means [“no [forceful/intentional] action”](https://en.wikipedia.org/wiki/Wu_wei), hence “effortless”.
					...
					- Blog post [Vô vi, tánh Không, trống rỗng, vacantness](https://creatzynotes.blogspot.com/2022/03/vo-vi-tanh-khong-trong-rong-vacancy.html) <a class="logseq-meta" data-collapsed="true" ></a>
						- 無為非不為，無為而無不為。
						  <br>Vô vi phi bất vi, vô vi nhi vô bất vi.
						  <br>Làm "Không" chẳng phải là không làm,
						  <br>làm "Không" mà chẳng có việc chi là không làm.
						- Chương 48. Vong tri (Quên đi cái Biết), Đạo Đức Kinh
							- Học nhiều càng lắm rườm rà,
							  <br>Càng gần Đạo cả càng ra đơn thuần.
							  <br>Xả buông rồi lại xả buông,
							  <br>Bụi trần rũ sạch còn thuần Vô vi.
							- Vô vi huyền diệu khôn bì,
							  <br>Làm "Không" mà chẳng việc chi không làm.
							  <br>Vô vi mà được thế gian,
							  <br>Càng xoay xở lắm đời càng rối beng.
	...
	- Turning negativity to positivity through the etymology of “occation” ← “occidō” (fall down) <a class="logseq-meta" data-collapsed="true" data-logbook="CLOCK: [2025-05-06 Tue 12:47:35]--[2025-05-06 Tue 13:08:23] =&gt;  00:20:48&#10;" ></a>
	...
	- From [logical “argument”](https://en.wikipedia.org/wiki/Argument) in philosophy to [“argument of function”](https://en.wikipedia.org/wiki/Argument_of_a_function) and then [“argument of complex number”](https://en.wikipedia.org/wiki/Argument_(complex_analysis)) <a class="logseq-meta" id="680b6063-e454-4cf6-835e-d6f726b8b871" data-collapsed="true" data-logbook="CLOCK: [2025-04-25 Fri 17:15:36]--[2025-04-28 Mon 20:17:48] =&gt;  75:02:12&#10;" ></a>
		- **Logical argument** is the one determining the degree of truth of a statement called “conclusion”.
			- [Etymology:](../../../publish/CommonMark/Namespace.cm.md#669a1e5f-734c-41c1-bf1c-21813b6e81d8) English “argument” ← “argue” ← French “arguer” ← Latin “arguere”: to make **reasoned** statements to prove or refute a proposition
			- Additional meaning in English: disagreement, dispute, quarrel <a class="logseq-meta" data-collapsed="true" ></a>
				- The original Latin “arguere” and French “arguer” don't have this meaning.
				- The spectrum of meaning:
				  <br>[Reasoning end:] argue that, argue for/against, argue on, argue (direct object), argue about, argue over, argue (intransitive), dispute, quarrel [:Quarreling end]
				...
				- In contrast to “argue”, “debate” orginally meant “fight over” but now means [formal argument](https://en.wikipedia.org/wiki/Debate).
					- [Etymology:](../../../publish/CommonMark/Namespace.cm.md#669a1e5f-734c-41c1-bf1c-21813b6e81d8) English “debate” ← French “débattre” = “de” (down) + Latin “battuere” (beat) = “beat down”
			...
			- Vietnamese: <a class="logseq-meta" data-collapsed="true" ></a>
		...
		- Ref:
			- [Why We Use "Argument" In Describing Complex Angles](https://www.math.toronto.edu/mathnet/questionCorner/argument.html)
			  <br>> To the best of our knowledge, the word argument was originally used by astronomers when referring to certain angles associated with orbits. ([argument of pericenter](https://en.wikipedia.org/wiki/Argument_of_periapsis))
	- Vietnamese phonemes <a class="logseq-meta" id="6809e1ea-1518-4460-be26-62881c47287f" data-collapsed="true" data-logbook="CLOCK: [2025-04-24 Thu 14:02:37]--[2025-04-24 Thu 15:52:03] =&gt;  01:49:26&#10;" ></a>
		...
		- “đ” /ɗ/ → “d” /ɗ̠ʲ/ voiced [alveolo-palatal](https://en.wikipedia.org/wiki/Alveolo-palatal_consonant) implosive stop → /ʄ/ [voiced palatal implosive](https://en.wikipedia.org/wiki/Voiced_palatal_implosive) stop → /ˀj/ → /j/
			...
			- Video [IPA 164 Voiced Palatal Implosive Stop ʄ](https://youtu.be/27WGLJCPWIk) <a class="logseq-meta" data-collapsed="true" ></a>
	...
	- The translation by $\vec{v} = (dx:dy:0)$ in [homogeneous coordinates](#67dcf2d3-4020-4477-b375-9bbb8c0b1336) is actually a **rotation** due to its [*scale invariance*](#67e1004d-1533-483b-ab39-4b91ffbedbdd) throughout all z-scaled planes: $\vec{v}_z = \overrightarrow{(dx⋅z,\, dy⋅z)}$ [on plane $z≠0$] $= \vec{v} = \overrightarrow{(dx, dy)}$ [on the standard plane $z = 1$]. <a class="logseq-meta" id="67e0fb13-1c89-4f27-825e-02027f368fa2" data-collapsed="true" data-logbook="CLOCK: [2025-03-24 Mon 13:59:25]--[2025-03-31 Mon 18:40:44] =&gt;  172:41:19&#10;" ></a>
		...
		- circular θ > parabolic φ > hyperbolic ψ <a class="logseq-meta" id="67e29bdb-9bce-4cb8-b993-79aa130a1831" ></a>
			...
			- The corresponding hyperbolic rotation can be constructed in 2 ways: <a class="logseq-meta" id="67e2a0e0-a6d9-4ad8-a601-24289f44d383" data-logbook="CLOCK: [2025-03-25 Tue 20:47:33]--[2025-03-25 Tue 20:57:06] =&gt;  00:09:33&#10;" ></a>
			...
			- Rotations as flows on conic grids <a class="logseq-meta" id="684f951a-4c9b-45c1-80b0-dc10d12a2dbb" ></a>
				...
				- These grids are the conic version of [orthogonal coordinates](https://en.wikipedia.org/wiki/Orthogonal_coordinates) which are the most common cases of [curvilinear coordinates](https://en.wikipedia.org/wiki/Curvilinear_coordinates). <a class="logseq-meta" data-collapsed="true" ></a>
					...
					- Notes:
						...
						- The [“radial hyperbolic coordinates”](https://en.wikipedia.org/wiki/Hyperbolic_coordinates) is different from the “orthogonal hyperbolic coordinates” above in that the “vertical lines” are radial lines $x/y = e^{2r}$, instead of hyperbolas $(x^2 - y^2)^2 = r^4$. This grid with radials is not orthogonal and is used in relativity physics. <a class="logseq-meta" id="684f951a-cb78-405b-b763-e9e7edfd5414" ></a>
			...
			- The conic rotations are special cases of the Lie group [SL(2,ℝ)](https://en.wikipedia.org/wiki/SL2(R)). <a class="logseq-meta" data-collapsed="true" ></a>
				...
				- The flows are [Lie exponentiations](https://en.wikipedia.org/wiki/Exponential_map_(Lie_theory)) of generators:
					...
					- Hyperbolic: 
					  <br>$G_h = \begin{bmatrix} 0 & 1 \\ 1 & 0 \end{bmatrix} \; ; \; \exp(ψG_h) = \begin{bmatrix} \cosh ψ & \sinh ψ \\ \sinh ψ & \cosh ψ \end{bmatrix}$
					  <br>$G_a = \begin{bmatrix} a & 0 \\ 0 & 1/a \end{bmatrix} \; ; \; \exp(ψG_a) = \begin{bmatrix} e^ψ & 0 \\ 0 & e^{-ψ} \end{bmatrix}$
		- In 2D, parabolic rotations can be used to compose both circular and hyperbolic rotations. <a class="logseq-meta" id="67e238fb-771f-483d-a04a-badff7c7c70a" ></a>
			- 4 triples of parabolic rotations equivalent to circular and hyperbolic rotations: <a class="logseq-meta" id="67e6168e-ff58-4d9d-94a7-6fee6f533044" ></a>
				- x-y-x triples
			...
			- A circular rotation [can be decomposed](https://en.wikipedia.org/wiki/Rotation_matrix#Decomposition_into_shears) into 3 parabolic rotations, or 2 parabolic rotations + squeeze.
				- Video: [Rotation by shearing](https://youtu.be/tHekokkHmlM) <a class="logseq-meta" data-collapsed="true" ></a>
					- {{video https://youtu.be/tHekokkHmlM}}
				- Video: [Rotation without rotating](https://youtu.be/1LCEiVDHJmc) for the good old low resolution Mario sprite. <a class="logseq-meta" data-collapsed="true" ></a>
					- {{video https://youtu.be/1LCEiVDHJmc}}
		- GeoGebra applets <a class="logseq-meta" id="67e299fa-4f76-482a-b586-adacb17dc064" ></a>
			- [HyperbolicRotation](https://www.geogebra.org/m/qhgvaamt)
			- [ConicRotations](https://www.geogebra.org/m/d67tfadb) for [circular θ > parabolic φ > hyperbolic ψ](#67e29bdb-9bce-4cb8-b993-79aa130a1831)
			...
			- [ConicMetricTransform](https://www.geogebra.org/m/yrzmwxqv) to transform the angle metric between elliptic, parabolic, hyperbolic, through y-axis scaling <a class="logseq-meta" id="67ea7d5e-1cbe-4815-984d-d843d65d4b83" ></a>
		- Components of the tranformation $R⋅ = (r⋅e^{idφ})⋅ = (r⋅ \overrightarrow{⟨dφ⟩})⋅$ <a class="logseq-meta" id="684f951a-c14f-47f5-ac07-0cabb58cf089" ></a>
			- radial component = scaling (multiplication, division): $⋅r$
			- transverse component = translation (addition, subtraction): $+dφ$ <a class="logseq-meta" data-logbook="CLOCK: [2025-03-24 Mon 13:30:46]&#10;CLOCK: [2025-03-24 Mon 14:16:57]&#10;" ></a>
			- Note: don't confuse $\overrightarrow{⟨dφ⟩}$ with $d\overrightarrow{⟨φ⟩}$! <a class="logseq-meta" data-collapsed="true" ></a>
			  <br>While $\overrightarrow{⟨dφ⟩}$ is unit vector around x-axis, $d\overrightarrow{⟨φ⟩}$ is a near-zero vector perpendicular to $\overrightarrow{⟨φ⟩}$.
	...
	- About [homogeneous coordinates](https://en.wikipedia.org/wiki/Homogeneous_coordinates) <a class="logseq-meta" id="67dcf2d3-4020-4477-b375-9bbb8c0b1336" data-collapsed="true" data-logbook="CLOCK: [2025-03-19 Wed 09:46:39]&#10;" ></a>
		...
		- Scale invariance: thanks to ratios $(x:y:z)$, instead of absolute values $(x,y,z)$, the homogeneous coordinates are unchanged throughout all z-scaled planes: $(x:y:z) = (x/z : y/z : 1)⋅z$. <a class="logseq-meta" id="67e1004d-1533-483b-ab39-4b91ffbedbdd" ></a>
		- Point $P = (x_0 : y_0 : 1) = (x_0, y_0)$ [on Euclidean plane $z = 1$] $= P_z = (x_0⋅z : y_0⋅z : z)$ [for z-scaled Euclidean plane $z≠0$] $= (x_0 : y_0 : 1)⋅z =$ line $(x_0, y_0)⋅t$ [in 3D]
			- The scaler $z$ is the “**depth**” of the object, which is the **distance** from the object plane to the viewpoint, and is the height of the [<span class="link-h3">view cone</span>](../../../publish/CommonMark/Uniinfo.cm.md#6672513b-c4b0-4c88-8b30-c60a3c6555a7).
		...
		- Vector $\vec{v} = (dx:dy:0) = \overrightarrow{(dx,dy)}$ [on Euclidean plane $z = 1$] $= D⋅P$ with [Displacement matrix $D$](#67dd6cb0-7522-427c-b714-5dd53a678b8d) and any point $P$ on Euclidean plane $z = 1$
			- Vector = “depthless” point = absolute point (point on the absolute plane $z = 0$) = point on the horizon = 
			  <br>[point at infinity](#67dd6f28-2497-4a11-bd16-afd31f24eaa4) (vanishing point)
		...
		- Translation $T = I + D  ⇒  T⋅P = I⋅P+D⋅P = P + \vec{v}$ <a class="logseq-meta" data-collapsed="true" ></a>
			- Identity matrix $I$
			  <br>$$ I = \begin{pmatrix} 1 & 0 & 0 \\ 0 & 1 &  0 \\ 0 & 0 & 1 \end{pmatrix} $$
			- Displacement matrix $D$ <a class="logseq-meta" id="67dd6cb0-7522-427c-b714-5dd53a678b8d" ></a>
			  <br>$$ D = \begin{pmatrix} 0 & 0 & dx \\ 0 & 0 &  dy \\ 0 & 0 &  0 \end{pmatrix} $$
		- Line $l = (x_0+dx⋅t : y_0+dy⋅t : 1) = (x_0+dx⋅t,\; y_0+dy⋅t)$ [on Euclidean plane $z = 1$] $=$ plane [in 3D]
		- Point at infinity = limit point of line $l$ = $\lim_{t→∞}(x_0+dx⋅t : y_0+dy⋅t : 1) = \lim_{t→∞}(x_0/t+dx : y_0/t+dy : 1/t) = (dx:dy:0) =$ vector $\vec{v}$ <a class="logseq-meta" id="67dd6f28-2497-4a11-bd16-afd31f24eaa4" data-logbook="CLOCK: [2025-03-21 Fri 20:58:44]&#10;" ></a>
		...
		- Refs:
			...
			- GeoGebra applet: [HomogeneousCoordinates](https://www.geogebra.org/m/csgsnafq) <a class="logseq-meta" data-logbook="CLOCK: [2025-03-21 Fri 20:09:27]&#10;" ></a>
	...
	- “wanting” = “lacking” ↔ “distress” = “overwhelming stress” = “anger” = “excessive pressure” <a class="logseq-meta" id="67cea2ee-5f77-4576-8c1c-9e31d9b822c9" data-collapsed="true" data-logbook="CLOCK: [2025-03-10 Mon 15:35:44]--[2025-03-10 Mon 20:07:20] =&gt;  04:31:36&#10;" ></a>
		- The greed ([rāga](https://en.wikipedia.org/wiki/Raga_(Buddhism))), desire, wanting are due to the **lacking**, the incompleteness within the self, which cause that self to look for, be **attracted** to and attach to its complements which bring **pleasure** to the self. <a class="logseq-meta" id="67ceb0d9-35c9-4805-8430-35c204658dbd" ></a>
		  <br>{{embed [Law of balance restoration](../../../publish/CommonMark/Uniinfo.cm.md#6667c99a-792f-4230-9fc6-c5fae874daef)}}
			...
			- “[Wanting](https://en.wiktionary.org/wiki/wanting)” as an adjective (still used in formal writing and literature) or as a preposition (quite rare in modern English) still means “lacking” in modern English.
				- E.g. as adjective: <a class="logseq-meta" data-collapsed="true" ></a>
					- By Copilot
					...
					- *Dead in the Water* [1993]
					  <br>> Kate felt privileged to have been permitted to speak through it and she was glad that, as before, she had been judged and not found **wanting**.
					- *Proceedings: [Entomological](https://en.wikipedia.org/wiki/Entomology) papers* [1902]
					  <br>> Discal black dot small or **wanting**. Transverse posterior line reduced to two dotlets or altogether **wanting**.
					- [Pride and Prejudice](https://en.wikipedia.org/wiki/Pride_and_Prejudice) [1813]
					  <br>> […] but where other powers of entertainment are **wanting**, the true philosopher will derive benefit from such as are given.
					- [Cato, a Tragedy](https://en.wikipedia.org/wiki/Cato,_a_Tragedy) [1712]
					  #+BEGIN_QUOTE
					  <br>Already *Cæsar*
					  <br>Has ravaged more than half the Globe, and sees
					  <br>Mankind grown thin by his destructive Sword:
					  <br>Should he go further, Numbers would be **wanting**
					  <br>To form new Battels, and support his Crimes.
					  #+END_QUOTE
				- E.g. as preposition: (by Copilot) <a class="logseq-meta" data-collapsed="true" ></a>
		...
		- Triads of the [<span class="link-h2">self</span>](../../../publish/CommonMark/Uniinfo.cm.md#667c015e-6223-4f8a-ae84-a93a49f4ff94) <a class="logseq-meta" id="67ced16d-2fbb-4c5d-9061-5d8f490f6073" ></a>
			- Three states: lacking - excessive - sufficient
			- Three forces: attration (affinity) - propulsion (aversion) - inertia (momentum)
			  <br>attractive force - propulsive force - inertial force
			...
			- [<span class="link-h2">Trinion</span>](../../../publish/CommonMark/Uniinfo.cm.md#669dfc7d-5355-41db-93a1-8d590e8ec9d8): Circle - Arrow - Equal
	- Some established formalisms for the notion of “distribution of space” in Unithread <a class="logseq-meta" id="67bda37c-7085-4a71-b5bf-6c4b54b3abdd" data-collapsed="true" ></a>
		- Clarify confusions about the “distribution **of** space”:
			- “Distribution of space” is the configuration of the space itself, not the distribution of objects in that space, nor the [space of probability distributions](https://en.wikipedia.org/wiki/Probability_space).
				- Google Search AI as well as other chatbots think of “distribution _of_ space” as “distribution _in_ space”. <a class="logseq-meta" data-collapsed="true" ></a>
		...
		- [Schwartz distribution](https://en.wikipedia.org/wiki/Distribution_(mathematics)) $T$ with action $T[]$ on a test function $φ()$ projecting the whole test function into a number $T[φ]$, usually through integration.
			...
			- Distributional derivative: $T'[φ] = - T[φ']$
			  <br>Action of derivative distribution $T'$ on test function $φ$ is the negative action of the original distribution $T$ on derivative of test function $φ'$.
		- Spacetime in General Relativity
			- [Einstein field equation](https://en.wikipedia.org/wiki/Einstein_field_equations) <a class="logseq-meta" id="67bdaa5e-66c0-4874-8ca6-95032208e06d" ></a>
			  <br>Distribution of energy ($T_{μν}$) $\sim$ distribution of space ($g_{μν}$)
			  <br>$κ T_{μν} = (Λ - \frac{1}{2} R) g_{μν} + R_{μν}$
				- Tensors
					...
					- $R_{μν},\,R$: [Ricci curvature tensor](https://en.wikipedia.org/wiki/Ricci_curvature) and [Ricci scalar curvature](https://en.wikipedia.org/wiki/Scalar_curvature) derived from the metric tensor $g_{μν}$ in a complicated manner
						- Ricci curvatures (tensor & scalar) are contractions of [Riemann curvature tensor](https://en.wikipedia.org/wiki/Riemann_curvature_tensor):
						  <br>$R_{μν} = g^{ab} R_{aμbν} \;;\; R = g^{μν} R_{μν} = 2 K = 2 κ_1 κ_2$
				...
				- Constants <a class="logseq-meta" data-collapsed="true" ></a>
			...
			- The Einstein field equation is so complicated with all kinds of tensors and curvatures! 🫤 <a class="logseq-meta" id="67bdb94a-e172-43f9-a59e-a97756fef1f4" ></a>
			- Einstein use curvature to refer to spacetime warping because it's crutial in General Relativity: [curvature = force](../../../publish/CommonMark/Uniinfo.cm.md#67b5c77d-c42c-4dc5-8d47-fd82f535177a) in [equivalence principle](https://en.wikipedia.org/wiki/Equivalence_principle) and various curvatures in [[Einstein field equation](https://en.wikipedia.org/wiki/Einstein_field_equations)](#67bdaa5e-66c0-4874-8ca6-95032208e06d). <a class="logseq-meta" id="67c11c75-41db-404c-a349-dd4b4876851d" data-collapsed="true" ></a>
				- The model of “heavy objects on a rubber sheet” is a common analogy.
				- Example curved space around Earth & Sun
				  <br>![curved-space-Earth-Sun-GettyImages.png](../assets/physics/curved-space-Earth-Sun-GettyImages.png)
				- [Steel balls on the trampoline](https://youtu.be/MTY1Kje0yLg), demo at a PTSOS workshop at Los Gatos High School, on March 10, 2012
				  <br>{{video https://youtu.be/MTY1Kje0yLg}}
			- However, the spacetime distribution represented by its density is much more intuitive and more fundamental, which is defined directly by the metric tensor $g_{μν}$ as the [transformation](../../../publish/CommonMark/Uniinfo.cm.md#669a58b9-eb34-41cd-8605-02e29b07e1b5) of spacetime. <a class="logseq-meta" data-collapsed="true" ></a>
				- Spacetime distortion of proper spacetime when projected onto a flat Cartesian coordinate system: <a class="logseq-meta" id="67c1273d-c336-4203-bc0d-68150f382c72" ></a>
				...
				- Spacetime distribution around a massive object, like the Sun 🌞, as shown in [Schwarzschild metric](https://en.wikipedia.org/wiki/Schwarzschild_metric)
					- Spacetime interval ($ds$) and proper time interval ($dτ$) in spherical coordinates $(t, r, θ, φ)$ with signature convention (+, -, -, -)
					  <br>$${ds}^2 = c^2 {dτ}^2 \;=\; ( 1 - \frac{R_s}{r} )c^2 {dt}^2 \; - ( 1 - \frac{R_s}{r} )^{-1} dr^2 \; - r^2 {dΩ}^2$$
					  <br>with ${dΩ}^2 = ({dθ}^2 + (\sin θ)^2 {dφ}^2)$ and [Schwarzschild radius](https://en.wikipedia.org/wiki/Schwarzschild_radius) $R_s = {2GM}/{c^2}$
					...
					- These coefficients have the same form with the [Lorentz factor](https://en.wikipedia.org/wiki/Lorentz_factor) $γ^2$ in Special Relativity: $γ^2 = (1 - (v/c)^2)^{-1}$
						...
						- When the object **flies faster** ($v↑$) in SR, or **approaches the center** ($r↓$) in GR, 
						  <br>$γ↓$ makes **length contract** and **time dilate**.
					...
					- Illustrations <a class="logseq-meta" data-collapsed="true" ></a>
						...
						- Animated GIF showing both length contraction & time dilation
						  <br>![General_relativity_time_and_space_distortion_extract.gif](../assets/physics/General_relativity_time_and_space_distortion_extract.gif)
						- Animated GIF of a moving object
						  <br>![warped-spacetime-moving-object-ezgif.gif](../assets/physics/warped-spacetime-moving-object-ezgif.gif)
						- [What if we could see Spacetime? An immersive experience](https://youtu.be/YNqTamaKMC8)
						  <br>{{video https://youtu.be/YNqTamaKMC8?t=200}}
				- DOING Relative to the subject's view, space is compressed under the coordinate view, while stretched under the proper view, or even both compressed and stretched under the middle view. <a class="logseq-meta" id="67d10ab3-018d-4c04-8d19-096eae010723" data-logbook="CLOCK: [2025-03-12 Wed 11:20:30]&#10;" ></a>
					- ...
					- Due to the traditional image of [curved spacetime](https://en.wikipedia.org/wiki/Curved_spacetime) from Einstein, many LLM chatbots are confused between the “stretch of space” of the model of [“heavy objects on a rubber sheet”](#67c11c75-41db-404c-a349-dd4b4876851d) and the “compressed space” in spacetime distribution. <a class="logseq-meta" data-collapsed="true" ></a>
						...
						- Arrived at the language of distribution: Grok 3, Meta AI
							...
							- Grok 3 directly [described](https://grok.com/share/bGVnYWN5_41d4563d-f787-47cb-adfa-66cc81da8f08) the distribution in the language of density without any suggestion 😊. However, further refinements revealed many confusions. I've tried hard to resolve those confusions and finally complete the 3-way relativity. <a class="logseq-meta" id="67f4eae8-b7f3-44af-b6fe-61591204f245" ></a>
					...
					- <zwsp>
			- So, the balance way should be using both: distribution for introductory level and curvatures for adavanced level. <a class="logseq-meta" data-collapsed="true" ></a>
				...
				- The Role of Curvature
					- [Curvature = force](../../../publish/CommonMark/Uniinfo.cm.md#67b5c77d-c42c-4dc5-8d47-fd82f535177a) in [equivalence principle](https://en.wikipedia.org/wiki/Equivalence_principle)
					- Curvatures in [[Einstein field equation](https://en.wikipedia.org/wiki/Einstein_field_equations)](#67bdaa5e-66c0-4874-8ca6-95032208e06d)
			...
			- “**Proper** space/time” = “**own** space/time” = “không/thời gian **riêng**” <a class="logseq-meta" data-collapsed="true" data-logbook="CLOCK: [2025-03-12 Wed 12:11:48]&#10;" ></a>
				- Etymology: Latin [proprius](https://en.wiktionary.org/wiki/proprius#Latin) (own, individual, private) → French [propre](https://en.wiktionary.org/wiki/propre#French) (own, specific, particular, appropriate, correct) → English: proper, property, appropriate
					...
					- Examples of the meaning “suitable for a _particular_ situation”:
						- Proper to itself
						  <br>> She likes everything to be in _its **proper**_ place.
						- Proper to me
						  <br>> I've had sandwiches but I haven't eaten a **proper** meal.
						- Proper to the job
						  <br>> I would have done the job myself but I didn't have the **proper** equipment.
						- Proper to the walk
						  <br>> If you're going to walk long distances you need **proper** walking boots.
				...
				- Some examples using “**proper to**” (given by Copilot) to highlights that certain characteristics, roles, or practices belong specifically to a particular context, group, or individual.
					- 1. Cultural Practices
					  <br>> These rituals are **proper to** the local community and have been passed down through generations.
					- 2. Geographical Features
					  <br>> The flora and fauna **proper to** this region are unique and diverse.
					- 3. Customs and Traditions
					  <br>> The dress code **proper to** this occasion requires formal attire.
					- 4. Specialized Roles
					  <br>> The duties **proper to** a physician include diagnosing and treating patients.
					- 5. Legal Context
	...
	- [stagger](https://www.facebook.com/share/p/35j9SSuqSJj76tWY/) = link (in space) = continuation (in time) = momentum <a class="logseq-meta" id="67b54283-14b2-4753-94bb-4d827d54d7cc" data-collapsed="true" data-logbook="CLOCK: [2025-02-19 Wed 09:40:27]&#10;" ></a>
		...
		- Stretching out by time, that transcycling becomes a double cone of [<span class="link-h2">view–control</span>](../../../publish/CommonMark/Uniinfo.cm.md#66725144-6bc9-4c9f-ba48-2cef02651e52) ~ [wave equation](https://en.wikipedia.org/wiki/Wave_equation) ~ [effect circle](../../../publish/CommonMark/Uniinfo.cm.md#674ff584-00e3-40d8-9b77-21e9dca899dd) = [Dynamics Circle](../../../publish/CommonMark/Uniinfo.cm.md#67b183f5-1cca-4473-917e-60c644dd5466). <a class="logseq-meta" id="67b5c778-71d6-4f58-9dd4-36a719bd85f0" ></a>
	- [?] What's the right term for the most basic operation: traversal, [transcycling](../../../publish/CommonMark/Uniinfo.cm.md#67a98760-71fa-4033-9c42-f3025d632d04), sprolling, ... <a class="logseq-meta" id="678b7762-1187-4330-93cb-7a62e14467a8" data-collapsed="true" data-logbook="CLOCK: [2025-01-18 Sat 19:12:36]&#10;" ></a>
		...
		- I'm discussing with Copilot, but the right image is blocked because it's "too sensitive!" 😯😧 <a class="logseq-meta" data-collapsed="true" ></a>
			- Maybe it looks like a crotch 🤔?!
			- I just want to make it clear that the circle is a loop ➰, not separate from the thread.
		- Copilot suggests "spooling" & "entwining". <a class="logseq-meta" data-collapsed="true" ></a>
		...
		- In general, there are 3 parts of this movement: thread input, rotating inside, and thread output.
			- In Unithread view, all [bodies](../../../publish/CommonMark/Uniinfo.cm.md#66c810a0-9861-4787-bdcf-1378219332be) in the worlds, from celestial bodies, organisms (thread = food & info), to simple physical objects (thread = energy), are "living" (existing) by this movement. The difference is just how complicated the "rotation" inside that body is.
			- I think “**transcycling** = cycling + translation” should be an apt term for this general movement.
				...
				- About the verb “to [transcycle](../../../publish/CommonMark/Uniinfo.cm.md#687743fd-9d45-45be-b9fd-3055cbb8a938)”: When an obop transcycles *on/along* the thread from left to right, it transcycles the thread through its body and effectively makes the thread move from right to left relative to the obop. <a class="logseq-meta" id="67a963d2-c9b5-47e0-9b4d-9d6323a76c28" ></a>
	...
	- [pipe wrapping](../../../publish/CommonMark/Uniinfo.cm.md#670cdcb4-3c85-45af-8c30-3c3284ed37df) = signal piping = message conveyance <a class="logseq-meta" id="676e46bc-5c19-4e37-a301-e3b818d8cb1a" data-collapsed="true" data-logbook="CLOCK: [2025-01-02 Thu 14:35:32]&#10;" ></a>
		...
		- The same meaning/image form different roots:
		  <br>“Both North & South poles are just two ends of the axis pole!”
	...
	- [Compound thread](2025%20Stories.cm.md#684f951a-1db2-4e43-9c5a-f4fbd27fe667) unmixed by different intent circles <a class="logseq-meta" id="6850be86-058c-45b4-9b4a-de92ebb4caff" data-collapsed="true" data-logbook="CLOCK: [2025-06-17 Tue 10:29:56]&#10;" ></a>
		...
		- The mixed object's content is [obop-projected](../../../publish/CommonMark/Uniinfo.cm.md#68908fbd-acc3-41a6-8c38-17ee1f014223) through different view cones to different images (extents) by different intent circles ⭕. All obops are watching the object in parallel with their different interests (intents).
