				  ...
				  collapsed:: true
					...
					- History of the **projective thread** of relation between quantities.
					  ...
					  :END:
						...
						- In Novemeber 2022, i contemplated the continuous transformation, i.e. [homotopy](https://en.wikipedia.org/wiki/Homotopy), from X to Y of the projective thread the function $f: X → Y$
