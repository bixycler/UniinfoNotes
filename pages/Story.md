			...
			- 17th, These days, my company works have accumulated into the form of the process where circles are formed by [mixmatching](((6916a4cf-2ac4-4843-a77c-9feae00db79c))) various threads.
			  collapsed:: true
				...
				- View by **_concurrent_ intents**: Fourier transform, wave interference, SCIFER chromatics
					...
					- In complex systems, the “memory loss” (of initial conditions) is due to [mixing](https://en.wikipedia.org/wiki/Mixing_(mathematics)) and [ergodicity](https://en.wikipedia.org/wiki/Ergodicity), and coarse-graining (increasing entropy).
