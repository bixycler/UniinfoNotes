			...
			- 16th, ...
			  collapsed:: true
				- Last night, in the bathroom, contemplating the force & momentum both in my bodymind and in mechanics, i saw how Unithread unifies them all together.
					...
					- The obop resolution determines dimensions, both spatial dimensions (basis in linear geometry) and dynamic dimensions (derivatives).
					- Higher dimensions are folded inside the quantum – beyond the current resolution.
						- “inner space” in intensional view = “higher dimension” in extensional view
