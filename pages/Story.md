				...
				- Cross-Origin Resource Sharing ([CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/CORS#requests_with_credentials)) with credentials (cookies) & redirect
				  ...
				  collapsed:: true
					...
					- Third-party cookies & Safari’s ITP
						...
						- Safari’s **ITP** will *not* send those cookies in iframes or AJAX if it thinks they’re “tracking”, and often purges them after 7 days (sometimes 24h if set by JS).
