		  ...
		  :END:
			...
			- 3rd June, from last night, my nose & throat have been a little sore.
				...
				- How to take quick notes at home (on Android mobile)?
					...
					- [Simplenote](https://simplenote.com/) looks good with Markdown syntax! 😊
					  collapsed:: true
						- Just test some features of Simplenote!
						- with list
							- 2nd level
							- 2.2
								- 3rd level
								...
								- The items look good!
							- No excessive indent!
						- I choose Simplenote just because of this listing thing! :D
						- What's a checklist?
						- [ ] A
						- [x] B
						- [ ] C
						- [ ] Each checkbox has the syntax `[x]` similar to Obsidian.
						  [x] but we cannot type `[x]` manually!
						- [ ] Must click the button! This is one down!
						  That's it!
						- About indent in/out
						- like this
							- Oh it's allowed!
