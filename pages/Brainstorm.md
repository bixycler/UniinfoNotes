		...
		- Unïnfo's interpretation of Einstein's statement that [“God does not play dice with the universe!”](https://en.wiktionary.org/wiki/God_does_not_play_dice_with_the_universe)
		  ...
		  collapsed:: true
			...
			- The “Space of Possibilities” and its measure – Probability
				...
				- Probability is the measure of the form (distortion) of the space of prossibilities. The form of the space is the distortion resulted from the interplay of the established laws and the actions of the beings within the system. It's used in Quantum mechanics, artificial neural networks, etc. This measure of uncertainty and potentiality, which are not due to a divine caprice, but because the fundamental  .
