		  ...
		  Human thought → deep-thinking model → thinking model → non-thinking model → simple model → traditional programs
			...
			- Self-modifying agentic AI
			  id:: 694a8c8b-c5c6-43b5-a21f-da8ba93a1462
				...
				- [Live-SWE-agent](https://arxiv.org/abs/2511.13646) ([github](https://github.com/OpenAutoCoder/live-swe-agent)): software engineering agents that evolve on-the-fly during execution
