		  ...
		  :END:
			...
			- derivative sequence
			  id:: 684796ee-1bc9-4828-882b-612c67ba48f3
				- ((6651ecba-793d-43c5-8020-a9f260b032d8)) ((684796ee-1bc9-4828-882b-612c67ba48f3)) of a function $f$, denoted by $(f^{(n)})_{n∈ℤ}$ or $(D^{n} f)_{n∈ℤ}$, is the sequence of all **successive derivatives** of 1st, 2nd, 3rd, ... (positive) orders to the right, and all **successive antiderivatives** of 1st, 2nd, 3rd, ... (negative) orders to the left, with the original function (0th order derivative) in the middle.
