		...
		- Unïnfo's interpretation of Einstein's statement that [“God does not play dice with the universe!”](https://en.wiktionary.org/wiki/God_does_not_play_dice_with_the_universe)
		  ...
		  collapsed:: true
			...
			- The “Space of Possibilities” and its measure – Probability
				...
				- Probability is the measure of the form (distortion) of the space of prossibilities. The distribution forms is the projection of the whole space of prossibilities into the mind of the observer. It's the distortion resulted from the interplay of the established laws and the actions of the beings within the system. Probability is used in Quantum mechanics, artificial neural networks, etc. to utilize the knowledge of the space, which is – though litmited and distorted – better than nothing.
