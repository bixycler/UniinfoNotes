		...
		- Unïnfo's interpretation of Einstein's statement that [“God does not play dice with the universe!”](https://en.wiktionary.org/wiki/God_does_not_play_dice_with_the_universe)
		  ...
		  collapsed:: true
			...
			- The “Space of Possibilities” and its measure – Probability
				...
				- Probability quantifies the **distortion** of the space of possibilities. The raw, unadulterated space of possibilities can be conceived as a uniform distribution. All subsequent distortions, leading to various observed distributions (forms of the space), are caused by the conditions of the observer. This condition can be subjective, as in Bayesian statistics, or objective, relating to the position, environment, or state of the system being observed. Probability is employed in fields like Quantum mechanics and artificial neural networks to model or navigate this space of possibilities. This knowledge of the space, though limited and distorted, is valuable in practice.
