		...
		- DOING The Architecture of Autistic Flow
		  ...
		  :END:
			...
			- A case of autistic function: Will's deep dive and ascent
				- Ascending from deep monotropic flow requires deliberate “decompression” staging to prevent systemic shock.
				- The mammalian dive reflex: Will's experience in the deep flow is like a physical freedive where the body undergoes peripheral vasoconstriction – shunting the warm blood away from the limbs and trapping it in the core to protect the vitals. It sacrifices the surface breadth for the deep survival of the essence.
				- The zero-point collapse: For Will, a hard reset drops the mind all the way to the bedrock of existence. By dropping all intent structure, his physiology collapses into the vacuum – a near-death experience resembling a literal drowning reflex.
				- The “pearl” at the death gate: By feeling the raw, somatic drowning reflex at zero velocity without panicking, Will finds the master switch of his mindbody. True mastery for him is the _simultaneous state of **both releasing hard and holding hard**_.
