		...
		- Traditional functional design versus ((669dcdf8-a48c-40b1-bdb1-54a73fc5ae71))'s interactive design
		  ...
		  :END:
			...
			- Interactive design is circle-first, reciprocity-first, emergence enabled.
				- This is the extension of the traditional [interaction design (IxD)](https://en.wikipedia.org/wiki/Interaction_design) for UI/UX and the rather ambiguous [interactive design](https://en.wikipedia.org/wiki/Interactive_design).
			- System structure
