		...
		- Traditional functional design versus ((669dcdf8-a48c-40b1-bdb1-54a73fc5ae71))'s interactive design
		  ...
		  :END:
			...
			- Interactive design is circle-first, reciprocity-first, emergence enabled.
				...
				- The [Persistent Turing Machine (PTM)](https://www.researchgate.net/publication/225181994_Persistent_Turing_Machines_as_a_Model_of_Interactive_Computation) model for Interactive Computation has proven that
