		...
		- Unïnfo's interpretation of Einstein's statement that [“God does not play dice with the universe!”](https://en.wiktionary.org/wiki/God_does_not_play_dice_with_the_universe)
		  ...
		  collapsed:: true
			...
			- The “Space of Possibilities” and its measure – Probability
				...
				- Probability is the measure of the form (distortion) of the space of prossibilities. It's used in Quantum mechanics, artificial neural networks, etc. This measure of uncertainty and potentiality, which are not due to a divine caprice, but because the fundamental “rules of the game” _**allow** for such multiplicity of choices and branching paths_. God doesn’t pre-ordain *which* possibility becomes actualized, but rather ensures that a spectrum of possibilities *exists*.
