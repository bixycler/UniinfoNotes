					...
					- The Grand Circle as a tree
					  ...
					  collapsed:: true
						...
						- Root system – Vacantism
						  id:: 6a3cef74-b7cd-4cb6-b4eb-00ca70f74f22
	  ...
	  ((665359e4-4597-4775-b849-f9acbb98960a)) ((678e23b4-0fbe-4a5d-923f-6252405053df))
		...
		- ((665359ff-79f1-4669-b10b-f2b0e633a7c1))
			...
			- “On a manifold” versus “in the Omnifold”
			  id:: 6a4606cd-7071-431e-a603-20573215cf4f
			  collapsed:: true
			  :LOGBOOK:
			  ...
			  :END:
				...
				- “On a manifold” – Manifold as a Base Space – the Floor
					...
					- The Bundle View: From the traditional definition of structures _over_ a domain (set) to the modern [fiber bundle](https://en.wikipedia.org/wiki/Fiber_bundle), the manifold $B$ is treated as a **base space** _upon_ which structures (functions, vectors, propositions, etc.) are defined by _erecting_ a “fiber” $F_x$ from each point $x ∈ B$ up to higher dimensions orthogonal to $B$, yielding the total space called “bundle”.
				...
				- “In the Omnifold” – Omnifold as a Primordial Medium – the Ocean
					...
					- The Living Sheaf View: Considering the Omnifold to be a [topos](https://en.wikipedia.org/wiki/Topos), we look at the local assignment of data *not over* a pre-existing floor, but as the primordial web of overlapping consistencies from which space itself emerges.
						- Rather than erecting static vertical “fibers” over dead points, the Omnifold operates through [germs](https://en.wikipedia.org/wiki/Germ_(mathematics)) – the infinitesimal seeds of intent and local momentum carrying intrinsic continuity.
						- In this dynamic medium, “points” are no longer foundational anchor stones; they dynamically emerge as focus-nodes where these localized effect flows evaluate and self-organize into germs.
						- Then, a global [section](https://en.wikipedia.org/wiki/Section_(fiber_bundle)) is not an arbitrary knife-cut through a frozen block universe, but the natural, continuous unfolding of the Ω-thread, organically generated by its local germ obop.
						- Thanks to [sites](https://en.wikipedia.org/wiki/Grothendieck_topology#Sites_and_sheaves), the germ is *no more a passive local limit*, but an *active tracking mechanism*: The site provides the syntax, and the germ is the semantic unit of continuity that flows through that syntax.
			- total amount = 1 = sum of content in each form dimension (extent) = product of intents of all forms
		  ...
		  collapsed:: true
			...
			- perception–action double cone
			  id:: 685156b0-2f3b-4aa9-8b87-636d38a02cd2
				- ((6651ecba-793d-43c5-8020-a9f260b032d8)) ((685156b0-2f3b-4aa9-8b87-636d38a02cd2)) is the part of the ((6851578b-9b1f-4367-878f-79b0b0b9be51)) limited within the ((66c810a0-9861-4787-bdcf-1378219332be)) of the ((667cfa3e-9856-43f0-956b-ebb4ff31d8eb)), i.e. perception cone > obop < action cone. As both nappes intend infinitely into the inner world of the subject, the double cone has a complex structure: the double cone folds back on itself to be a single cone and is modularized into layers of ((68df2d82-e1d5-49c4-ac40-d45cf26f840c))s.
			...
			- Effect circle Dynamic caused by Intentional cause
			  ...
			  collapsed:: true
				...
				- ((665359ff-79f1-4669-b10b-f2b0e633a7c1))
					...
					- In Buddhism, the **yin arrow** corresponds to [impermanence (anicca)](https://en.wikipedia.org/wiki/Impermanence_(Buddhism)), the _**urge** of the **yang arrow** to close the gap_ corresponds to [craving (taṇhā)](https://en.wikipedia.org/wiki/Ta%E1%B9%87h%C4%81), and the endless cycle of the yang arrow chasing its own tail but can never close the gap completely is the [suffering (duḥkha)](https://en.wikipedia.org/wiki/Du%E1%B8%A5kha) in [Saṃsāra](https://en.wikipedia.org/wiki/Sa%E1%B9%83s%C4%81ra).
					  id:: 6a80e807-eeb3-4b75-835d-c80008b3d9ac
		-
	- ## thread
