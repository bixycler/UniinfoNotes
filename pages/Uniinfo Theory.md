			...
			- “On a manifold” versus “in the Omnifold”
			  ...
			  :END:
				...
				- “On a manifold” – Manifold as a Base Space – the Floor
					...
					- The Bundle View (Point-Bound Reductionism): From the traditional definition of structures _over_ a domain (set) to the modern [fiber bundle](https://en.wikipedia.org/wiki/Fiber_bundle), the manifold is treated as a **base space** _upon_ which structures (functions, vectors, propositions, distributions, etc.) are defined by erecting a “fiber” from each point into higher dimensions, yielding the total space of the bundle.
